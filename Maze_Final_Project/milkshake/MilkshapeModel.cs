    ...
    public class MilkshapeModel
    {
        ...
        private uint CreateTexture(string fileName)
        {
            ...
            try
            {
                ...
                {
                    // החזרת טקסטורה ברירת מחדל אם הקובץ לא קיים
                    return texCount; // פשוט החזרת מספר טקסטורה ריק
                }
            ...
            {
                // אם יש שגיאה, פשוט נמשיך בלי הטקסטורה
                if (bitmap != null)
                    bitmap.Dispose();
            }
        ...
        public virtual void BindMaterial(int materialIndex)
        {
            ...
            else
            {
                ...
                if ((material.transparency < 1.0f) || (material.mode == Model.HASALPHA))
                {
                    ...
                    GL.glLightModeli(GL.GL_LIGHT_MODEL_TWO_SIDE, (int)1);
                ...
                else
                {
                    ...
                    GL.glLightModeli(GL.GL_LIGHT_MODEL_TWO_SIDE, (int)0);
                }
